const menuFactory = function() {
    ...
    function createMenu() {
        ...
        debug === 1 && (menuCard1.innerHTML = '<img src="../src/assets/images/burger.jpg">\n' + '<h3>Burger</h3>');
        debug === 0 && (menuCard1.innerHTML = '<img src="./assets/images/burger.jpg">\n' + '<h3>Burger</h3>');

        debug === 1 && (menuCard2.innerHTML = '<img src="../src/assets/images/pho.jpg">\n' + '<h3>Pho</h3>');
        debug === 0 && (menuCard2.innerHTML = '<img src="./assets/images/pho.jpg">\n' + '<h3>Pho</h3>');

        debug === 1 && (menuCard3.innerHTML = '<img src="../src/assets/images/tacos.jpg">\n' + '<h3>Tacos de Carne Asada</h3>');
        debug === 0 && (menuCard3.innerHTML = '<img src="./assets/images/tacos.jpg">\n' + '<h3>Tacos de Carne Asada</h3>');

        debug === 1 && (menuCard4.innerHTML = '<img src="../src/assets/images/pancakes.jpg">\n' + '<h3>Pancakes</h3>');
        debug === 0 && (menuCard4.innerHTML = '<img src="./assets/images/pancakes.jpg">\n' + '<h3>Pancakes</h3>');

        debug === 1 && (menuCard5.innerHTML = '<img src="../src/assets/images/steak.jpg">\n' + '<h3>Steak</h3>');
        debug === 0 && (menuCard5.innerHTML = '<img src="./assets/images/steak.jpg">\n' + '<h3>Steak</h3>');

        debug === 1 && (menuCard6.innerHTML = '<img src="../src/assets/images/shrimps.jpg">\n' + '<h3>Roasted Shrimp</h3>');
        debug === 0 && (menuCard6.innerHTML = '<img src="./assets/images/shrimps.jpg">\n' + '<h3>Roasted Shrimp</h3>');
